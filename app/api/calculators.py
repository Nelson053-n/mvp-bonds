...
_CALC_CSS = """<style>
.calc-card{background:var(--slate-900);border:1px solid var(--slate-800);
border-radius:var(--radius-lg);padding:22px;margin:18px 0}
.calc-card h2{margin:0 0 14px;font-size:17px}
.calc-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px}
.field label{display:block;font-size:12px;color:var(--slate-500);margin-bottom:5px}
.field input,.field select{width:100%;background:#0b1424;border:1px solid var(--slate-700);
...
.calc-result{margin-top:16px;padding:14px 16px;background:rgba(37,99,235,.08);
border:1px solid rgba(59,130,246,.3);border-radius:var(--radius);font-size:14px}
.calc-result .big{font-size:24px;font-weight:800;color:var(--green-400)}
...
.formula{background:var(--slate-900);border-left:3px solid var(--blue-500);
padding:10px 14px;border-radius:var(--radius);font-size:14px;color:#cbd5e1;margin:12px 0;
font-family:ui-monospace,monospace}
.calc-links{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:12px;margin:18px 0}
.calc-links a{display:block;background:var(--slate-900);border:1px solid var(--slate-800);
border-radius:var(--radius-lg);padding:18px}
.calc-links a:hover{border-color:var(--slate-600);text-decoration:none}
.calc-links .t{font-size:15px;font-weight:700;color:#fff;margin-bottom:4px}
.calc-links .d{font-size:13px;color:var(--slate-400)}
</style>"""
